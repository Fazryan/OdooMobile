package com.example.fpp_109.odoomobile;
...
import de.timroes.axmlrpc.XMLRPCClient;
    ...
    public class OdooUtility {
        ...
        OdooUtility(String serverAddress, String path) {
            try {
                url  = new  URL(serverAddress + "/xmlr pc/2/"  + path);
         ...
         *	@param  uid user id integer returned from login
         *	@param   password
         ...
         **************************************************************************/
         ...
         public long search_read(XMLRPCCallback listener,
                                 String db, String uid, String password, String object, List  conditions,
        ...
        public long create(XMLRPCCallback listener,
                           String db, String  uid, String password, String  object, List  data){
            long id = client .callAsync(listener, "execute_kw" , db, Integer.parseInt(uid), password,
                    object, "create" , data);
            return id;
        }
        ...
        public long exec(XMLRPCCallback listener,
                         String db, String  uid, String password, String  object, String method, List  data){
            long id = client .callAsync(listener, "execute_kw" , db, Integer.parseInt(uid), password,
                    object, method, data);
            return id;
        }
         ...
         *	@return
         *********************************************************************/
        public long delete(XMLRPCCallback listener, String  db,
                           String  uid, String password, String  object, List  data){
            long id = client .callAsync(listener, "execute_kw" , db, Integer.parseInt(uid), password,
                    object, "unlink" , data);
            return id;
        }
    ...
    public String value ;
        ...
        public static M2OField getMany2One(Map<String,Object> classObj, String fieldName){
            ...
            Integer fieldId=0; String fieldValue="" ;
            M2OField  res  =  new  M2OField();
            if (classObj.get(fieldName) instanceof Object[]){ Object[] field = (Object[])classObj.get(fieldName); if (field.length  >0  ){
                fieldId  =   (Integer)field[0]; fieldValue  =  (String)field[1];
            }
            }
            res.id = fieldId;
        ...
        public static String getString(Map<String,Object> classObj, String fieldName){
            String res = "" ;
            if (classObj.get(fieldName) instanceof String){ res = (String)classObj.get(fieldName);
            }
            return  res;
        }
        ...
        public static Double getDouble(Map<String,Object> classObj, String fieldName){
            Double res = 0.0;
            if (classObj.get(fieldName) instanceof  Double){ res = (Double)classObj.get(fieldName);
            }
            return  res;
        }
        ...
        public static Integer getInteger(Map<String,Object> classObj, String fieldName){
            Integer res = 0;
            if (classObj.get(fieldName) instanceof  Double){ res  =  (Integer)classObj.get(fieldName);
            }
            return  res;
        }

        public  void  MessageDialog(Context context, String  msg){ AlertDialog.Builder   alertDialogBuilder   =   new
